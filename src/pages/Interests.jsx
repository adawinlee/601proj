    ...
    return (
        <main id="int-main">
            ...
            <div id="book-grid">
                <div className="book">
                    <img 
                        src="https://www.marthawells.com/Murderbot1.jpg" 
                        alt="The book cover of All Systems Red" 
                ...
                <div className="book">
                    <img 
                        src="https://m.media-amazon.com/images/I/81BAA6IwKEL._SL1500_.jpg" 
                        alt="The book cover of What Moves the Dead" 
                        className="book-cover">
                    </img>
                ...
                <div className="book">
                    <img 
                        src="https://elitistbookreviews.com/wp-content/uploads/2020/03/Gideon-the-Ninth.jpg" 
                        alt="The book cover of Gideon the Ninth" 
                        className="book-cover">
                    </img>
                ...
                <div className="book">
                    <img 
                        src="https://utopia-state-of-mind.com/wp-content/uploads/2020/07/The-Space-Between-Worlds-by-Micaiah-Johnson.jpg" 
                        alt="The book cover of The Space Between Worlds" 
                        className="book-cover">
                    </img>
                ...
                <div className="book">
                    <img 
                        src="https://media.npr.org/assets/img/2020/07/09/91kikzx6cdl_custom-f0b2be087ea32e8694f07a7984831181275356f9-s1100-c50.jpg" 
                        alt="The book cover of Mexican Gothic" 
                        className="book-cover">    
                    </img>
                ...
                <div className="book">
                    <img 
                        src="https://i1.wp.com/geekylibrary.com/files/2014/03/ancillaryjusticecover2.jpg?fit=948%2C1422" 
                        alt="The book cover of Ancillary Justice" 
                        className="book-cover">
                    </img>
